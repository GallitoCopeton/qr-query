...
def qr_search(QR_code):
    ...
    if LOCAL or CLOUD:
        local_image_browser = ImageBrowser(QR_code, DB1, 'local')
        ...
        if not local_image_result['found']:
            ...
            cloud_image_browser = ImageBrowser(QR_code, DB2, 'cloud')
    ...
    if LOCAL or CLOUD:
        local_data_browser = DataBrowser(QR_code, DB1, 'local')
        ...
        if not local_data_result['found']:
            ...
            cloud_data_browser = DataBrowser(QR_code, DB2, 'cloud')
